...
set terminal epslatex size 9,6 standalone color colortext 17 header "\\usepackage[utf8]{inputenc}\n\\usepackage[T1]{fontenc}\n\\usepackage[slovak]{babel}"
set output 'ify24.tex'
unset clip points
set clip one
unset clip two
...
set xzeroaxis linetype -1 linewidth 2.000
...
set title "Graf závislosti $U_b$ na frekvencii $f$" 
...
y(x) = 3.688e-15 * x - 1.164
GNUTERM = "wxt"
GPFUN_y = "y(x) = 3.688e-15 * x - 1.164"
plot [0:10e+14][-2:2] 'ify24.dat' with points title 'namerané hodnoty' ps 4 lw 3, y(x) with lines linestyle 1 title '$ 3.688e^{-15} * x - 1.164$'
#    EOF
